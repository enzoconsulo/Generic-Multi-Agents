...
FIGS = os.path.join(AQUI, "figs_en")
DESTINO = r"C:\Users\enzoc\OneDrive\Documentos\Gerador_de_projetos\multi-agent-software-factory-COMPLETE-en.docx"
...
def parte(numero, titulo_txt, resumo, cor="2A78D6"):
    ...
    par.paragraph_format.space_after = Pt(1)
    par.paragraph_format.alignment = WD_ALIGN_PARAGRAPH.LEFT
    fonte(par.add_run("PART " + numero + "   "), tam=8.5, negrito=True, cor=BRANCO)
