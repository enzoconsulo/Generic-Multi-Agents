...
partes = ["documento7_en_base.py", "corpo7a_en.py", "corpo7b_en.py", "corpo7c_en.py"]
fonte = "\n".join(io.open(os.path.join(AQUI, n), encoding="utf-8").read() for n in partes)
io.open(os.path.join(AQUI, "documento7_en.py"), "w", encoding="utf-8").write(fonte)
...
exec(compile(fonte, "documento7_en.py", "exec"),
     {"__name__": "__main__", "__file__": os.path.join(AQUI, "documento7_en.py")})
